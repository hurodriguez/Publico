...
$(document).ready(function() {
	...
	var openRequest = window.indexedDB.open("db_hugo",1);
    ...
    function displayNotes(filter) {
        ...
        var content="<table class='table table-bordered table-striped'><thead><tr><th>Title</th><th>Contenido</th><th>&nbsp;</td></thead><tbody>";
        ...
        var handleResult = function(event) {  
          ...
          if (cursor) {  
            ...
            content += "<td>"+cursor.value.body+"</td>";

            content += "<td><a class=\"btn btn-primary edit\">Editar</a> <a class=\"btn btn-danger delete\">Borrar</a></td>";
            content +="</tr>";
            cursor.continue();  
          }  
          else {  
